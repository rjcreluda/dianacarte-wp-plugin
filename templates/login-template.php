...
<section class="parallax-section" data-scrollax-parent="true" id="sec1">
    ...
    <div class="container">
        <div class="section-title center-align">
            <h3>Se connecter à votre espace</h3>
            <?php 
    	...
    	<div class="row">
            ...
            <?php endif;?>
                <div class="list-single-main-wrapper fl-wrap" id="sec2">
					...
					?>
					<form id='registration-form' method='post' action='<?php echo get_site_url() . '/user/login'; ?>'>
						<div class="custom-form">
	                        ...
	                        <button type="submit" class="log-submit-btn"><span>Se connecter<i class="fa fa-spinner fa-pulse"></i></span></button>
	                    </div>
					</form>
                </div>
